...
Actual data: http://py4e-data.dr-chuck.net/comments_2143399.json (Sum ends with 78)
...
data = urlhandle.read()
info = json.loads(data) #to parse json data as python dictionaries
print("Count: ", len(info["comments"]))
sum = 0
cmtlist = info['comments'] #list of dictionaries
for i in range(len(cmtlist)):
    sum = sum + cmtlist[i]['count']
print("Sum: ", sum)